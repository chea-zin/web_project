    ...
    <div class="scroll-sidebar" data-sidebarbg="skin6">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="user.php"
                ...
                <li class="nav-small-cap"><span class="hide-menu">ADD NEW ITEMS</span></li>

                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="category_add.php"
                        aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                            class="hide-menu">Add Category</span></a>
                </li>

                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="user_create.php"
                        aria-expanded="false"><i data-feather="users" class="feather-icon"></i><span
                            class="hide-menu">Add User</span></a>
                </li>

                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="product_add.php"
                        aria-expanded="false"><i data-feather="grid" class="feather-icon"></i><span
                ...
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link"
                        href="register.php" aria-expanded="false"><i data-feather="lock"
